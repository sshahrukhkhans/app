...
const renderServiceContent = (serviceName) => {
  if (serviceName === "Comprehensive Audit Support Services") {
    return (
      <>
        <h2>Comprehensive Audit Support Services</h2>
        <p>
          We deliver end-to-end audit support across the entire engagement lifecycle,
          from initial planning through final documentation and quality review.
        </p>
        ...
        <div className="service-reveal-grid">
          <article className="service-reveal-card">
            ...
            <p>
              Engagement planning, risk assessment worksheets, materiality
              computation, internal control walkthroughs, and analytical
              procedures for unusual fluctuations.
            </p>
          </article>
          ...
          <article className="service-reveal-card">
            ...
            <p>
              PBC request lists, workpaper organization across CCH Axcess,
              CaseWare, Thomson Reuters, indexing, referencing, and audit
          ...
          <article className="service-reveal-card service-reveal-card-wide">
            ...
            <p>
              Comprehensive testing of balance sheet and income statement
              accounts, including confirmations, analytical reviews, and
              transaction testing.
            </p>
          </article>
        </div>
  ...
  if (serviceName === "Substantive Audit Procedures") {
    return (
      <>
        <h2>Substantive Audit Procedures</h2>
        <p>
          Our team executes detailed substantive audit procedures covering all
          major financial statement areas, ensuring thorough documentation and
          compliance.
        </p>
        ...
        <div className="service-reveal-grid">
          <article className="service-reveal-card">
            ...
            <ul className="service-reveal-list">
              ...
              <li>Accounts Receivable: Confirmations, aging analysis, subsequent receipts</li>
              <li>Inventory: Remote observation, valuation, roll-forward testing</li>
              <li>Fixed Assets: Depreciation, additions/disposals, CAPEX verification</li>
              <li>Investments: Fair value testing, market price verification</li>
              <li>Loans &amp; Debts: Agreement review, interest calculations, covenants</li>
            </ul>
          </article>
          ...
          <article className="service-reveal-card">
            ...
            <ul className="service-reveal-list">
              ...
              <li>Operating Expenses: Sampling, analytical review procedures</li>
              <li>Payroll: Register testing, compliance checks, analytical reviews</li>
            </ul>
          </article>
        </div>
      </>
  ...
  if (serviceName === "Internal Controls & Financial Reporting") {
    return (
      <>
        <h2>Internal Controls &amp; Financial Reporting</h2>
        <p>
          We also prepare audit adjustments (AJE), reclassification entries
          (RJE), and provide clear explanations to support CPA-client
          communications.
        </p>
        ...
        <div className="service-reveal-grid">
          <article className="service-reveal-card">
            ...
            <p>
              SOX 404 documentation support, process narratives, flowcharts,
              control matrices, design and implementation testing, and
          ...
          <article className="service-reveal-card">
            ...
            <p>
              Planning and final analytics, working capital and liquidity
              ratios, profitability and leverage analysis, and variance
              identification for audit conclusions.
            </p>
          </article>
          ...
          <article className="service-reveal-card">
            ...
            <p>
              AR/AP, legal, and bank confirmations through platforms like
              Confirmation.com with comprehensive response tracking and
              documentation.
            </p>
          </article>
  ...
  if (serviceName === "Specialized Support Services") {
    return (
      <>
        ...
        <div className="service-reveal-grid">
          <article className="service-reveal-card">
            ...
            <p>
              Federal and state tax working papers, book-to-tax reconciliation,
              support for Forms 1120, 1065, 1040 schedules, and IRS provision
              research assistance.
            </p>
          </article>
          ...
          <article className="service-reveal-card">
            ...
            <p>
              Professional skepticism documentation, partner review support,
              audit sampling methodologies, and evidence trail preparation
              ensuring workpapers meet PCAOB inspection standards.
            </p>
          </article>
          ...
          <article className="service-reveal-card service-reveal-card-wide">
            ...
            <p>
              Internal review for completeness and accuracy, audit completion
              checklists, management representation letter drafting, and
              partner review schedule preparation.
            </p>
          </article>
        </div>
      </>
  ...
  if (serviceName === "Industry Expertise & Project Management") {
    return (
      <>
        <h2>Industry Expertise &amp; Project Management</h2>
        <p>
          Seamless coordination with global teams ensures efficient workflows
  ...
  if (serviceName === "Compliance, Security & Ethical Standards") {
    return (
      <>
        <h2>Compliance, Security &amp; Ethical Standards</h2>
        <p>
          Your data security and regulatory compliance are our top priorities.
          We operate under the highest professional and ethical standards.
        </p>
        <div className="service-reveal-grid">
          <article className="service-reveal-card">
          ...
          <article className="service-reveal-card">
            ...
            <p>
              Full adherence to AICPA Professional Code of Conduct, PCAOB audit
              standards, and ICAI ethical guidelines governing chartered
              accountant practice.
            </p>
          </article>
          <article className="service-reveal-card service-reveal-card-wide">
            ...
            <p>
              Enterprise-grade security systems, encrypted cloud storage,
              multi-factor authentication, secure VPN access, and regular
  ...
  return (
    <>
      ...
      <p>
        ...
        judgement to each situation. Our innovative approaches create original
        solutions to our clients most complex domestic and multi jurisdictional
        matters.
      </p>
      <p className="service-highlight">
        Over the last 35 years we made a strong impact and continue to deliver
        dependable outcomes.
      </p>
      <p>
        These concepts shape our distinctive culture and differentiate us from
        others. We anticipate client needs, provide practical support and build
        lasting relationships with quality-focused execution.
      </p>
    </>
  );
};
...
const ServicePage = () => {
  ...
  useEffect(() => {
    const handleDocumentClick = (event) => {
      ...
      if (target.closest(".service-copy")) return;
      setHoveredService("");
      setSelectedService("");
    };
        ...
        <div className="container service-main-grid">
          <aside className="service-sidebar">
            {serviceItems.map((item) => (
              <div key={item} className="service-sidebar-item">
                <button
                  ...
                  onClick={() =>
                    setSelectedService((prev) =>
                      isMobileAccordion && prev === item ? "" : item
                    )
                  }
                >
                ...
                {isMobileAccordion && selectedService === item ? (
                  <article className="service-copy service-copy-mobile is-revealed">
                    {renderServiceContent(item)}
                  </article>
                ) : null}
              </div>
            ))}
          ...
          {isMobileAccordion && !selectedService ? (
            <article className="service-copy service-copy-mobile service-copy-mobile-default is-revealed">
          ...
          {!isMobileAccordion ? (
            <article className={`service-copy ${revealedService ? "is-revealed" : ""}`}>
              {renderServiceContent(revealedService)}
            </article>
          ) : null}
        </div>
      </section>
